  ...
  return (
    <header className="container px-4 lg:px-6 h-14 flex items-center">
      <Link className="flex items-center justify-center" href="/">
        <Image src={"https://cdn.recorder.betaco.tech/logo.png"} alt='' height={128} width={128} className="h-9 w-9"/>
      ...
      <nav className="ml-auto flex gap-4 sm:gap-6 items-center">
        ...
        <Link
          ...
          target="_blank"
        >
          {/* <Button className="inline-flex items-center gap-2 justify-center rounded-md bg-gradient-to-r from-blue-500 to-purple-500 px-6 py-2 text-xl font-medium text-white shadow-lg transition-colors hover:from-blue-600 hover:to-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
          🔌 Boost Your Blog 
          </Button> */}
        </Link>
      </nav>
